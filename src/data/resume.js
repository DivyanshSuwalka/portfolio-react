export const resumeData = {
  ...
  skills: {
    ...
    frameworks: ["React.js", "Redux", "Next.js", "Tailwind CSS", "Bootstrap", "Express.js", "Spring Boot"],
    databases: ["MySQL", "PostgreSQL", "MongoDB", "Mongoose"],
    tools: ["VS Code", "Postman", "Git", "GitHub", "npm", "Webpack", "Chrome DevTools"]
  },
  ...
  experience: [
    {
      ...
      location: "Remote",
      responsibilities: [
        "Enhanced website performance by 55% via code-splitting, asset minification and SQL indexing.",
        "Delivered cross-browser UI components with React JS + Tailwind CSS following mobile-first principles.",
        "Partnered with DevOps on CI/CD pipelines (Docker & GitHub Actions) to cut deploy time 30%.",
        "Upskilled in TypeScript and Next.js; prototyped SSR module reducing TTFB 18%."
      ]
    },
    {
  ...
  projects: [
    {
      name: "Food Garage",
      description: "Engineered a modular and reusable component library using React Hooks, increasing code maintainability and team efficiency by 25% across three separate projects. Added lazy loading, shimmer placeholders and offline/online handling; reduced Cumulative Layout Shift (CLS) by 32%. Custom hooks fetch menus per restaurant ID; cut perceived API latency 40%.",
    ...
    },
    {
      ...
      description: "Full-stack app with JWT auth and RBAC (Admin / Student). Exposed RESTful APIs for registration, course CRUD, enroll/unenroll; 100% Postman test coverage. Streamlined many-to-many queries via Mongoose populate; accelerated DB response time 30%.",
    ...
    },
    {
      ...
      description: "Integrated appointment scheduling functionality with the application, enabling users to book slots directly through the app; personally resolved 10+ bugs flagged by the QA team. Implemented geo-location search and clustering; boosted average session duration 25%.",
